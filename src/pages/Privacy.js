        ...
        <main className='container'>
            <div className='section'>
                ...
                <div className=''>
                    ...
                    <p>Acordarea consimțământului asupra utilizării cookie-urilor în concordanță cu termenii acestei politici atunci când vizitați website-ul nostru pentru prima dată, ne permite să utilizăm cookie-uri de fiecare dată când vizitați website-ul nostru.</p>
                    
                    <h4>B. Colectarea informațiilor personale</h4>
                ...
                <h4>C. Utilizarea informațiilor dvs. personale</h4>
                ...
                <ul>
                    ...
                    <li>verificarea respectării termenilor și condițiilor care reglementează utilizarea website-ului nostru (inclusiv monitorizarea mesajelor private trimise prin intermediul serviciului nostru de mesagerie privată); și alte utilizări.</li>
                </ul>
                ...
                <h4>D. Divulgarea informațiilor personale</h4>
                ...
                <ul>
                    ...
                    <li>către cumpărătorul (sau potențialul cumpărător) al oricărei afaceri sau oricărui bun pe care le-am vândut (sau avem în plan să îl vindem); </li>
                    <li>și oricărei persoane considerăm în mod rezonabil că s-ar putea adresa unei instanțe sau unei alte autorități competente pentru divulgarea informațiilor personale în cazul în care, în opinia noastră rezonabilă, o astfel de instanță sau autoritate ar putea să dispună divulgarea informațiilor personale. </li>
                </ul>
                <p>Cu excepția situațiilor prevăzute în această politică, nu vom furniza informațiile dvs. personale către terți.</p>
                
                <h4>E. Transferuri internaționale de date</h4>
                <p>Informațiile pe care le colectăm pot fi stocate, prelucrate și transferate între oricare dintre țările în care funcționăm pentru a ne permite să utilizăm informațiile în conformitate cu această politică.</p>
                <p>Informațiile colectate pot fi transferate între următoarele țări care nu au instituite legi de protecție a datelor personale echivalente cu cele în vigoare în Spațiul Economic European: Statele Unite ale Americii, Rusia, Japonia, China și India.</p>
                <p>Informațiile personale pe care le publicați pe website-ul nostru sau pe care le trimiteți spre publicare pe website-ul nostru pot fi disponibile prin internet în întreaga lume. Nu putem împiedica utilizarea sau utilizarea greșită a acestor informații de către alții.</p>
                <p>Sunteți de acord în mod expres cu transferurile de informații personale descrise în această Secțiune (E).</p>
                
                <h4>F. Păstrarea informațiilor personale</h4>
                <p>Această Secțiune G stabilește politicile și procedurile noastre de păstrare a datelor, care sunt concepute pentru a ajuta la asigurarea respectării obligațiilor noastre legale cu privire la păstrarea și ștergerea informațiilor personale.</p>
                ...
                <p>Fără a aduce atingere articolului G-2, de obicei ștergem datele cu caracter personal care se încadrează în categoriile prezentate mai jos la data/ora stabilite mai jos:</p>
                <ul>
                    <li>informațiile de tip personal vor fi șterse [INTRODUCEȚI DATA/ORA]; și [INTRODUCEȚI MAI MULTE DATE/ORE].</li>
                    <li>În pofida celorlalte dispoziții din această Secțiune G, vom păstra documente (inclusiv documente electronice) care conțin date cu caracter personal: în măsura în care ni se solicită acest lucru prin lege;</li>
                    <li>dacă considerăm că documentele pot fi relevante pentru orice procedură legală în derulare sau viitoare;</li>
                    <li>pentru a stabili, exercita sau apăra drepturile noastre legale (inclusiv furnizarea de informații către terți în scopul prevenirii fraudelor și reducerea riscului de credit);</li>
                </ul>
                
                <h4>G. Securitatea informațiilor dvs. personale</h4>
                ...
                <p>Sunteți responsabil(ă) pentru păstrarea confidențialității parolei pe care o utilizați pentru accesarea website-ului nostru; nu vă vom solicita niciodată parola (cu excepția momentului când vă conectați pe website-ul nostru).</p>
                ...
                <ul>
                    <li>plata unei taxe [INTRODUCEȚI „GRATUIT” DACĂ SE APLICĂ];</li>
                    ...
                    <li>Putem reține informațiile personale pe care le solicitați în măsura permisă de lege.</li>
                </ul>
                ...
                <h4>K. Actualizarea informațiilor</h4>
                ...
                <p>Numele cookie-urilor pe care le folosim pe website-ul nostru și scopurile pentru care sunt utilizate acestea pot fi găsite mai jos:</p>
                <ul>
                    <li>Folosim Google Analytics și Adwords pe website-ul nostru pentru a recunoaște un computer atunci când un utilizator [INCLUDEȚI TOATE UTILIZĂRILE PENTRU CARE SUNT FOLOSITE COOKIE-URI PE WEBSITE-UL DVS., vizitează website-ul / urmărește utilizatorii cât timp navighează pe website / permite activarea unui coș de cumpărături pe website / îmbunătățește capacitatea de utilizare a website-ului / analizează utilizarea website-ului / administrează website-ul / previne fraudele și îmbunătățește securitatea website-ului / personalizează website-ul pentru fiecare utilizator / direcționează reclame care pot fi de interes deosebit pentru utilizator / descrieți scopul (scopurile)];</li>
                </ul>
                ...
                <p>Ștergerea cookie-urilor va avea un impact negativ asupra utilizabilității multor website-uri.</p>
                </div>
            </div>
